...
BEHAVIOR_DATA_PROCESSED = os.path.join(BEHAVIOR_PATH, "processed")
# Raw behavioral CSV layout: ``raw/{subject}/{subject}_{task}.csv``.
BEHAVIOR_DATA_RAW = os.path.join(BEHAVIOR_PATH, "raw")
